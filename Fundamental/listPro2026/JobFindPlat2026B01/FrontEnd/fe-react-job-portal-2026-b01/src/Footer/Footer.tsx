  ...
  return (
    <>
      {location.pathname !== "/signup" && location.pathname !== "/login" ? (
        <>
          <div className="pt-20 pb-5 flex gap-5 justify-around bg-mine-shaft-600 font-['poppins']">
            <div
              className="
        ...
        "
            >
              ...
              <div className="text-sm text-mine-shaft-300">
                Job portal with user profiles, skill updates, certification,
                work experince and job posting
              </div>
