package com.phucdn.createQrCode.controller;
...
import com.phucdn.createQrCode.model.QRCodeGenerator;
...
public class QRCodeController {
	...
	public void download(@PathVariable("codeText") String codeText,
		...
		throws Exception{
		QRCodeGenerator.generateQRCodeImage(codeText, width, height, 
				QR_CODE_IMAGE_PATH);
	}
